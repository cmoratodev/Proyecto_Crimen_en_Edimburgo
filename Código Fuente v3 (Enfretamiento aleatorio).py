...
╚═════════════════════════════════════════════╝
""")
    selec_inicio = int(input("Elige qué quieres hacer(1, 2, 3): "))
    ...
    if selec_inicio == 1:
        ...
        pygame.mixer.music.play(-1) 
        os.system("cls")
        saludo1 = "¡Bienvenido a Edimburgo! En esta aventura te encarnarás en Mark, un detective de la división de crimenes\n\n"
        print("""
                                  _._
                               .-~ | ~-.
                               |   |   |
